...
<div class="container-custom">
    ...
    <div class="top-controls">
        ...
        <a href="<?php echo e(route('marketing.dashboard')); ?>" class="btn btn-search" style="text-decoration:none;">
    ...
    <div class="card filter-card">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('marketing.customers.index')); ?>">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="search_type" class="form-select">
                            ...
                            <option value="vip" <?php echo e(request('search_type')=='vip' ? 'selected' : ''); ?>>VIP</option>
                            <option value="regular" <?php echo e(request('search_type')=='regular' ? 'selected' : ''); ?>>عادي</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                        ...
                        <select name="search_status" class="form-select">
                            ...
                            <option value="active" <?php echo e(request('search_status')=='active' ? 'selected' : ''); ?>>فعال</option>
                            <option value="inactive" <?php echo e(request('search_status')=='inactive' ? 'selected' : ''); ?>>غير فعال</option>
                        </select>
                    </div>
            ...
            <?php if(request('search_name') || request('search_email') || request('search_type') || request('search_status')): ?>
                <div class="text-center mt-3">
                    <a href="<?php echo e(route('marketing.customers.index')); ?>" class="btn btn-secondary" id="resetBtn">إلغاء الفلتر</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="table-container">
        <div class="d-flex justify-content-between mb-3">
            ...
            <span class="badge bg-secondary" id="countBadge">عدد النتائج: <?php echo e($customers->count()); ?></span>
        </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody id="customersTable">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($c->firstNmae); ?> <?php echo e($c->lastName); ?></td>
                        <td><?php echo e($c->email); ?></td>
                        <td><?php echo e($c->phone); ?></td>
                        <td>
                            <?php $typeId = $c->customer_type_id ?? 1; ?>
                            <span class="<?php echo e($typeId == 2 ? 'badge-vip' : 'badge-regular'); ?>">
                                <?php echo e($typeId == 2 ? 'VIP' : 'عادي'); ?>

                            </span>
                        </td>
                        <td>
                            <?php $statusId = $c->customer_status_id ?? 1; ?>
                            <span class="<?php echo e($statusId == 1 ? 'badge-active' : 'badge-inactive'); ?>">
                                <?php echo e($statusId == 1 ? 'فعال' : 'غير فعال'); ?>

                            </span>
                        </td>
                        <td>
                            <a href="<?php echo e(route('marketing.customers.show', $c->personal_id)); ?>" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                            <a href="<?php echo e(route('marketing.customers.edit', $c->personal_id)); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                            <?php if(session('user.role') === 'manager'): ?>
                                <a href="<?php echo e(route('marketing.customers.changeStatus', [$c->personal_id, 1])); ?>" class="btn btn-sm btn-success">تفعيل</a>
                                <a href="<?php echo e(route('marketing.customers.changeStatus', [$c->personal_id, 2])); ?>" class="btn btn-sm btn-danger">تعطيل</a>
                                <form action="<?php echo e(route('marketing.customers.destroy', $c->personal_id)); ?>" method="POST" style="display:inline-block;">
                                    <?php echo csrf_field(); ?>
...
<script>
    ...
    $('#searchName').on('input', function () {
        ...
        $.get('<?php echo e(route("marketing.customers.index")); ?>', { search_name: name }, function (html) {
...
</html><?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/customers/index.blade.php ENDPATH**/ ?>