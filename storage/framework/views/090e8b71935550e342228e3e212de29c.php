...
<div class="form-card">
    <h2 id="pageTitle">✏️ تعديل العرض</h2>
    ...
    <form method="POST" action="<?php echo e(route('marketing.offers.update', $offer->offer_id)); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <div class="mb-3">
            <label id="nameLabel" class="form-label">اسم العرض</label>
            <input type="text" name="offer_name" class="form-control" value="<?php echo e(old('offer_name', $offer->offer_name)); ?>" required>
        </div>

        <div class="mb-3">
            <label id="detailsLabel" class="form-label">تفاصيل العرض</label>
            <textarea name="offer_details" class="form-control" rows="3"><?php echo e(old('offer_details', $offer->offer_details)); ?></textarea>
        </div>

        <div class="row">
            <div class="col-md-6 mb-3">
                <label id="startLabel" class="form-label">تاريخ البداية</label>
                <input type="date" name="start_date" class="form-control" value="<?php echo e(old('start_date', $offer->start_date)); ?>">
            </div>

            <div class="col-md-6 mb-3">
                <label id="endLabel" class="form-label">تاريخ النهاية</label>
                <input type="date" name="end_date" class="form-control" value="<?php echo e(old('end_date', $offer->end_date)); ?>">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="status" class="form-control">
                <option value="نشط" <?php echo e($offer->status == 'نشط' ? 'selected' : ''); ?>>نشط</option>
                <option value="منتهي" <?php echo e($offer->status == 'منتهي' ? 'selected' : ''); ?>>منتهي</option>
            </select>
        </div>

        <div class="text-center mt-4">
            <button type="submit" class="btn-submit px-5 py-2" id="updateBtn">💾 تحديث العرض</button>
...
<script>
    ...
    function applyLanguage() {
        ...
        if (currentLang === 'ar') {
            ...
            document.getElementById('pageTitle').innerHTML = '✏️ تعديل العرض';
            ...
            document.getElementById('updateBtn').innerHTML = '💾 تحديث العرض';
            document.getElementById('cancelBtn').innerHTML = '🔙 إلغاء';
        } else {
            html.setAttribute('dir', 'ltr');
            document.getElementById('pageTitle').innerHTML = '✏️ Edit Offer';
            ...
            document.getElementById('updateBtn').innerHTML = '💾 Update Offer';
...
</html><?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/offers/edit.blade.php ENDPATH**/ ?>