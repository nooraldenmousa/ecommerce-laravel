...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Block 3 Dashboard'); ?></title>
...
<nav class="navbar navbar-expand-lg navbar-custom mb-4">
    <div class="container">
        <a class="navbar-brand fw-bold text-primary" href="<?php echo e(route('block3.dashboard')); ?>">
            <i class="fa-solid fa-warehouse me-2"></i>MyStore Block 3
        </a>

        <div class="d-flex gap-2">
            <a href="<?php echo e(route('block3.dashboard')); ?>" class="btn btn-sm btn-outline-primary">Dashboard</a>
            <a href="<?php echo e(route('block3.stores.index')); ?>" class="btn btn-sm btn-outline-primary">Stores</a>
            <a href="<?php echo e(route('block3.transfer.form')); ?>" class="btn btn-sm btn-primary">Transfer</a>
        </div>
    </div>
</nav>
...
<?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/layouts/block3.blade.php ENDPATH**/ ?>