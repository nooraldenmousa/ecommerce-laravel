...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="error-msg"><i class="fas fa-exclamation-circle"></i> <?php echo e($message); ?></div>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/auth/login.blade.php ENDPATH**/ ?>