...
<div class="top-controls">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="btn-back" style="text-decoration: none;">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center mb-4">
                <?php if($customer->upload_file): ?>
                    <img src="<?php echo e(asset('storage/' . $customer->upload_file)); ?>"
                         alt="صورة الزبون"
                         class="customer-img">
                <?php else: ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($customer->firstNmae); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                        <span class="info-label" id="lastNameLabel">الاسم الأخير:</span>
                        <span class="info-value"><?php echo e($customer->lastName); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                        <span class="info-label" id="fatherLabel">اسم الأب:</span>
                        <span class="info-value"><?php echo e($customer->father ?? 'غير محدد'); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                ...
                <div class="col-md-6">
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($customer->phone); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                        <span class="info-label" id="nationalLabel">الرقم الوطني:</span>
                        <span class="info-value"><?php echo e($customer->national_number); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                        <span class="info-label" id="birthdayLabel">تاريخ الميلاد:</span>
                        <span class="info-value"><?php echo e($customer->birthday ?? 'غير محدد'); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                        <span class="info-label" id="addressLabel">العنوان:</span>
                        <span class="info-value"><?php echo e($customer->address ?? 'غير محدد'); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                        ...
                        <span class="info-value">
                            <span class="badge <?php echo e($customer->customer_type_id == 2 ? 'bg-warning' : 'bg-info'); ?>">
                                <span id="typeValue"><?php echo e($customer->customer_type_id == 2 ? 'VIP' : 'عادي'); ?></span>
                            </span>
                        </span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-row">
                        ...
                        <span class="info-value">
                            <span class="badge <?php echo e($customer->customer_status_id == 1 ? 'bg-success' : 'bg-danger'); ?>">
                                <span id="statusValue"><?php echo e($customer->customer_status_id == 1 ? 'فعال' : 'غير فعال'); ?></span>
                            </span>
                        </span>
                    </div>
                </div>
        ...
        <?php if($customer->customer_type_id == 2): ?>
                ...
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="alert alert-info">
                            <strong><?php echo e($offer->offer_name); ?></strong><br>
                            <?php echo e($offer->offer_details ?? 'لا يوجد تفاصيل'); ?>

                            <?php if($offer->start_date && $offer->end_date): ?>
                                <br><small>من <?php echo e($offer->start_date); ?> إلى <?php echo e($offer->end_date); ?></small>
                            <?php endif; ?>
                        </div>
        ...
        <div class="card-footer text-center">
            <a href="<?php echo e(route('marketing.customers.index')); ?>" class="btn-back" id="backBtn">
...
<script>
    ...
    function applyLanguage() {
        ...
        if (currentLang === "ar") {
            ...
            document.getElementById("typeValue").innerHTML = "<?php echo e($customer->customer_type_id == 2 ? 'VIP' : 'عادي'); ?>";
            document.getElementById("statusValue").innerHTML = "<?php echo e($customer->customer_status_id == 1 ? 'فعال' : 'غير فعال'); ?>";
            ...
            document.getElementById("typeValue").innerHTML = "<?php echo e($customer->customer_type_id == 2 ? 'VIP' : 'Normal'); ?>";
            document.getElementById("statusValue").innerHTML = "<?php echo e($customer->customer_status_id == 1 ? 'Active' : 'Inactive'); ?>";
...
<?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/customers/show.blade.php ENDPATH**/ ?>