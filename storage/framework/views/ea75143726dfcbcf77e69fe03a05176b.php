...
<div class="container-custom">
    ...
    <div class="top-controls">
        ...
        <a href="<?php echo e(route('hr.employees.create')); ?>" class="btn btn-search">
            <i class="fas fa-user-plus"></i> إضافة موظف
        </a>
        <a href="<?php echo e(route('hr.dashboard')); ?>" class="btn btn-search" style="text-decoration:none;">
    ...
    <div class="card filter-card">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('hr.employees.index')); ?>">
                <div class="row g-3">
                    <div class="col-md-2">
                        <label class="form-label">Name</label>
                        <input type="text" name="name" id="nameInput" class="form-control"
                               value="<?php echo e(request('name')); ?>" placeholder="Search by Name">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label">Email</label>
                        <input type="text" name="email" class="form-control"
                               value="<?php echo e(request('email')); ?>" placeholder="Search by Email">
                    </div>
                    <div class="col-md-2">
                        ...
                        <select name="department_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($d->department_id); ?>"
                                    <?php echo e(request('department_id') == $d->department_id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="status_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->employee_status_id); ?>"
                                    <?php echo e(request('status_id') == $s->employee_status_id ? 'selected' : ''); ?>>
                                    <?php echo e($s->status); ?>
                        ...
                        <select name="role_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($r->role_id); ?>"
                                    <?php echo e(request('role_id') == $r->role_id ? 'selected' : ''); ?>>
                                    <?php echo e($r->type); ?>
            ...
            <?php if(request('name') || request('email') || request('department_id') || request('status_id') || request('role_id')): ?>
                <div class="text-center mt-3">
                    <a href="<?php echo e(route('hr.employees.index')); ?>" class="btn btn-secondary">إلغاء الفلتر</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="table-container">
        <div class="d-flex justify-content-between mb-3">
            ...
            <span class="badge bg-secondary">Namber of Results : <?php echo e($employees->count()); ?></span>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="employeeTable">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($i + 1); ?></td>
                        <td>
                            <img src="<?php echo e($e->upload_file ? asset('storage/'.$e->upload_file) : 'https://via.placeholder.com/50'); ?>"
                                 width="50" style="border-radius:50%; object-fit:cover; height:50px;">
                        </td>
                        <td><?php echo e($e->firstNmae); ?> <?php echo e($e->lastName); ?></td>
                        <td><?php echo e($e->email); ?></td>
                        <td><?php echo e($e->department->department_name ?? '-'); ?></td>
                        <td><?php echo e($e->role->type ?? '-'); ?></td>
                        <td>
                            <?php $status = $e->employeeStatus->status ?? ''; ?>
                            <?php if($status == 'active' || $status == 'موظف حالي'): ?>
                                <span class="badge-active">موظف حالي</span>
                            <?php elseif($status == 'inactive' || $status == 'مفصول'): ?>
                                <span class="badge-inactive">مفصول</span>
                            <?php else: ?>
                                <span class="badge-leave"><?php echo e($status ?: '-'); ?></span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <a href="<?php echo e(route('hr.employees.show', $e->personal_id)); ?>"
                               class="btn btn-sm btn-info">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="<?php echo e(route('hr.employees.edit', $e->personal_id)); ?>"
                               class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <?php if(session('user.role') == 'manager'): ?>
                                <button class="btn btn-sm btn-success"
                                        onclick="openStatusModal(<?php echo e($e->personal_id); ?>, <?php echo e($e->employee_status_id ?? 1); ?>)">
                                    <i class="fas fa-toggle-on"></i>
                                </button>
                                <form action="<?php echo e(route('hr.employees.destroy', $e->personal_id)); ?>"
                ...
                <form id="statusForm" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="employee_status_id" id="statusSelect" class="form-select">
                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->employee_status_id); ?>"><?php echo e($s->status); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
$('#nameInput').on('input', function() {
    ...
    $.get('<?php echo e(route("hr.employees.search")); ?>', { name: name }, function(data) {
        let rows = '';
        if (data.length === 0) {
...
</html><?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/block1/employees/index.blade.php ENDPATH**/ ?>