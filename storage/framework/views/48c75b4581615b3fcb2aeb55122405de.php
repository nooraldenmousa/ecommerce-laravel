...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'نظام المتجر الإلكتروني'); ?></title>
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="<?php echo e(route('warehouse.dashboard')); ?>"
           class="<?php echo e(request()->routeIs('warehouse.dashboard') ? 'active' : ''); ?>">
            <i class="fas fa-chart-pie"></i>
            لوحة التحكم
        </a>

        <a href="<?php echo e(route('warehouse.index')); ?>"
           class="<?php echo e(request()->routeIs('warehouse.index') ? 'active' : ''); ?>">
            <i class="fas fa-warehouse"></i>
            المستودعات
        </a>
        ...
        <a href="<?php echo e(route('warehouse.create')); ?>"
           class="<?php echo e(request()->routeIs('warehouse.create') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/layouts/app.blade.php ENDPATH**/ ?>