...
<div class="container-custom">
    ...
    <div class="top-controls">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-search" style="text-decoration:none;">
            <i class="bi bi-house-door"></i> Dashboard
        </a>
        <a href="<?php echo e(route('marketing.offers.create')); ?>" class="btn btn-search" style="text-decoration:none;">
    ...
    <div class="table-container">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($i+1); ?></td>
                        <td><?php echo e($offer->offer_name); ?></td>
                        <td><?php echo e($offer->offer_details ?? '-'); ?></td>
                        <td><?php echo e($offer->start_date ?? '-'); ?></td>
                        <td><?php echo e($offer->end_date ?? '-'); ?></td>
                        <td><?php echo e($offer->status ?? 'نشط'); ?></td>
                        <td>
                            <a href="<?php echo e(route('marketing.offers.show', $offer->offer_id)); ?>" class="btn btn-sm btn-info">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="<?php echo e(route('marketing.offers.edit', $offer->offer_id)); ?>" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="<?php echo e(route('marketing.offers.destroy', $offer->offer_id)); ?>" method="POST" style="display:inline-block;">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/offers/index.blade.php ENDPATH**/ ?>