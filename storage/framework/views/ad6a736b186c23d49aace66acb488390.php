...
<div class="form-card">
    ...
    <form method="POST"
          action="<?php echo e(route('marketing.customers.update', $customer->personal_id)); ?>"
        ...
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <input type="text" name="firstNmae" class="form-control" value="<?php echo e(old('firstNmae', $customer->firstNmae)); ?>" required>
            </div>

            <div class="col-md-6">
                <label id="lastNameLabel">الاسم الأخير</label>
                <input type="text" name="lastName" class="form-control" value="<?php echo e(old('lastName', $customer->lastName)); ?>" required>
            </div>

            <div class="col-md-6">
                <label id="fatherLabel">اسم الأب</label>
                <input type="text" name="father" class="form-control" value="<?php echo e(old('father', $customer->father)); ?>">
            </div>

            <div class="col-md-6">
                <label id="nationalLabel">الرقم الوطني</label>
                <input type="number" name="national_number" class="form-control" value="<?php echo e(old('national_number', $customer->national_number)); ?>" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="birthday" class="form-control" value="<?php echo e(old('birthday', $customer->birthday)); ?>">
            </div>

            <div class="col-md-4">
                <label id="typeLabel">نوع الزبون</label>
                <select name="customer_type_id" class="form-control" required>
                    <option value="1" <?php echo e($customer->customer_type_id == 1 ? 'selected' : ''); ?> id="normalOption">عادي</option>
                    <option value="2" <?php echo e($customer->customer_type_id == 2 ? 'selected' : ''); ?> id="vipOption">VIP</option>
                </select>
            </div>
            ...
            <div class="col-md-4">
                ...
                <?php if(session('user.role') === 'manager'): ?>
                    <select name="customer_status_id" class="form-control" required>
                        <option value="1" <?php echo e($customer->customer_status_id == 1 ? 'selected' : ''); ?> id="activeOption">فعال</option>
                        <option value="2" <?php echo e($customer->customer_status_id == 2 ? 'selected' : ''); ?> id="inactiveOption">غير فعال</option>
                    </select>
                <?php else: ?>
                    <input type="text" class="form-control" value="<?php echo e($customer->customer_status_id == 1 ? 'فعال' : 'غير فعال'); ?>" disabled>
                    <input type="hidden" name="customer_status_id" value="<?php echo e($customer->customer_status_id); ?>">
                <?php endif; ?>
            </div>
            ...
            <div class="col-md-4">
                ...
                <select name="assigned_to" class="form-control">
                    ...
                    <option value="1" <?php echo e($customer->assigned_to ? 'selected' : ''); ?>>مرتبط</option>
                </select>
            </div>
            <?php endif; ?>
            ...
            <div class="col-12 text-center mt-4">
                ...
                <a href="<?php echo e(route('marketing.customers.index')); ?>" class="btn-back px-4 py-2" id="cancelBtn">🔙 إلغاء</a>
            </div>
        </div>
    </form>
</div>
...
<?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/customers/edit.blade.php ENDPATH**/ ?>