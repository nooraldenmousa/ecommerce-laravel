...
<?php $__env->startSection('page-title', 'تعديل بيانات المنتج'); ?>
    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header">
                ...
                تعديل: <strong><?php echo e($product->product_name); ?></strong>
            </div>
            <div class="card-body p-4">
                <form action="<?php echo e(route('product.update', $product->product_id)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="3" class="form-control"
                                      placeholder="أدخل وصف المنتج..."><?php echo e(old('description', $product->description)); ?></textarea>
                        </div>
                    ...
                    <div class="d-flex gap-3 justify-content-end">
                        ...
                        <a href="<?php echo e(route('product.show', $product->product_id)); ?>" class="btn btn-outline-info">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/product/edit.blade.php ENDPATH**/ ?>