...
<div class="container-custom">
    ...
    <div class="header">
        ...
        <div class="title">
            ...
            قسم: <?php echo e($department->department_name); ?>
        ...
        <div style="display:flex;gap:10px;">
            ...
            <a href="<?php echo e(route('hr.departments.index')); ?>" class="btn-back">
        ...
        <div class="emp-card">
            ...
            <div>
                <div style="font-weight:700;">
                    <?php echo e($e->firstNmae); ?> <?php echo e($e->lastName); ?>

                </div>

                <span class="badge-role">
                    <?php echo e($e->role_name); ?>
            ...
            <div style="display:flex;gap:8px;align-items:center;">
                ...
                <form action="<?php echo e(route('hr.departments.remove', $department->department_id)); ?>"
                      method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="personal_id" value="<?php echo e($e->personal_id); ?>">
                ...
                <form action="<?php echo e(route('hr.departments.changeRole', $department->department_id)); ?>"
                    ...
                    <select name="role_id" class="form-select form-select-sm" style="width:110px;">
                        <option value="1" <?php echo e($e->role_id == 1 ? 'selected' : ''); ?>>مدير</option>
                        <option value="2" <?php echo e($e->role_id == 2 ? 'selected' : ''); ?>>موظف</option>
                    </select>
    ...
    <?php if(session('role_id') == 1 && count($availableEmployees) > 0): ?>

    <div class="card-box">

        <h5 class="mb-3">➕ تعيين موظف</h5>

        <form action="<?php echo e(route('hr.departments.assign', $department->department_id)); ?>"
            ...
            <select name="personal_id" class="form-select">
                ...
                <?php $__currentLoopData = $availableEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($emp->personal_id); ?>">
                        <?php echo e($emp->firstNmae); ?> <?php echo e($emp->lastName); ?>
...
<?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/block1/departments/employees.blade.php ENDPATH**/ ?>