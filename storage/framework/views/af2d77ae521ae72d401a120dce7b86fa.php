...
<div class="sidebar">
    <div class="sidebar-header">
        ...
        <small>مرحباً، <?php echo e(session('user.name') ?? session('username')); ?></small>
    </div>

    <div class="nav-section">القائمة الرئيسية</div>
    <a href="<?php echo e(route('hr.dashboard')); ?>" class="nav-link active">
        <i class="fas fa-home"></i> لوحة التحكم
    </a>

    <div class="nav-section">إدارة الموظفين</div>
    <a href="<?php echo e(route('hr.employees.index')); ?>" class="nav-link">
        <i class="fas fa-user-tie"></i> قائمة الموظفين
    </a>
    <a href="<?php echo e(route('hr.employees.create')); ?>" class="nav-link">
        <i class="fas fa-user-plus"></i> إضافة موظف
    </a>

    <div class="nav-section">إدارة الأقسام</div>
    <a href="<?php echo e(route('hr.departments.index')); ?>" class="nav-link">
        <i class="fas fa-sitemap"></i> الأقسام
    </a>
    <a href="<?php echo e(route('hr.departments.create')); ?>" class="nav-link">
    ...
    <div class="row g-4">
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo e($totalEmployees ?? 0); ?></div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-number">
                    <?php echo e(session('user.role') === 'manager' ? 'مدير' : 'موظف'); ?>
        ...
        <div class="col-md-6">
            <div class="stat-card text-start">
                ...
                <div class="d-flex flex-column gap-2">
                    <a href="<?php echo e(route('hr.employees.create')); ?>" class="btn btn-primary rounded-3">
                        <i class="fas fa-user-plus me-2"></i> إضافة موظف جديد
                    </a>
                    <a href="<?php echo e(route('hr.departments.index')); ?>" class="btn btn-outline-primary rounded-3">
                        <i class="fas fa-sitemap me-2"></i> إدارة الأقسام
                    </a>
                    <a href="<?php echo e(route('hr.employees.index')); ?>" class="btn btn-outline-secondary rounded-3">
            ...
            <div class="stat-card text-start">
                ...
                <table class="table table-borderless mb-0" style="font-size:0.9rem;">
                    <tr>
                        ...
                        <td><strong><?php echo e(session('user.username') ?? session('username')); ?></strong></td>
                    </tr>
                    <tr>
...
<?php /**PATH C:\xampp\htdocs\wp2 project\complete_project\resources\views/hr/dashboard.blade.php ENDPATH**/ ?>