...
<div class="profile-card">
    ...
    <div class="text-center">
        <img class="profile-img"
             src="{{ $employee->upload_file ? asset('storage/'.$employee->upload_file) : 'https://via.placeholder.com/120' }}">
    </div>
    ...
    <div class="info-grid">
        ...
        <div class="info-box">
            ...
            <div class="value">{{ $employee->firstNmae }}</div>
        </div>
        ...
        <div class="info-box">
            ...
            <div class="value">{{ $employee->national_number }}</div>
        </div>
        ...
        <div class="info-box">
            ...
            <div class="value">{{ $employee->address ?? 'غير محدد' }}</div>
        </div>
        ...
        <div class="info-box">
            ...
            <div class="value">{{ $employee->department->department_name ?? '-' }}</div>
        </div>

        <div class="info-box">
            <div class="label">الوظيفة</div>
            <div class="value">{{ $employee->role->type ?? '-' }}</div>
        </div>
